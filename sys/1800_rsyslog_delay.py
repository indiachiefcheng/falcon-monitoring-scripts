...
if delay > 86400:
    os.system('systemctl restart rsyslog &>/dev/null')
def create_record():
    record = {}
    ...
    data.append(record)
create_record()
data.append({"endpoint": endpoint, "metric": "monitor.scripts.health", "timestamp": ts, "step": 1800, "value": status, "counterType": "GAUGE", "tags": "scripts=1800_rsyslog_delay.py"}) 
